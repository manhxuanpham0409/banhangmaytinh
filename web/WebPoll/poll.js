...
function FillAnswerArea(el){
    ...
    for(i=0;i<el;i++){
      ...
      txt = txt + '<input name="answer'+i+'" type="text" id="answer'+i+'" size="30" maxlength="80" value="' + aVal + '"> votes count <input name="start'+i+'" type="text"  id="start'+i+'" size="2" maxlength="4" value="' + sVal + '"><br>';
    }
